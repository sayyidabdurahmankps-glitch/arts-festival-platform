      ...
      {statCards.map((stat, i) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${stat.gradientFrom} to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`}
            />

            <div
              className={`shrink-0 p-4 md:p-5 rounded-2xl md:rounded-[1.25rem] border shadow-inner mb-0 sm:mb-5 xl:mb-0 relative z-10 transition-transform duration-500 group-hover:scale-110 ${stat.bgClass} ${stat.borderClass}`}
            >
